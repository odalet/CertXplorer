...
{
    /// <summary>
    /// Adds shortcut methods to the <see cref="ILogService"/> interface.
    /// </summary>
    internal static class LoggingExtensions
    {
        public static void Log(this ILogService logService, string level, string message) => logService.Log(level, message, null);

        public static void Log(this ILogService logService, string level, Exception exception) => logService.Log(level, string.Empty, exception);
