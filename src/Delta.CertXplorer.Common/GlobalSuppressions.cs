...
[assembly: SuppressMessage("Critical Bug", "S4275:Getters and setters should access the expected fields", Justification = "<Pending>", Scope = "member", Target = "~P:Delta.CertXplorer.UI.HexViewer.SelectionLength")]
[assembly: SuppressMessage("Major Code Smell", "S3925:\"ISerializable\" should be implemented correctly", Justification = "<Pending>", Scope = "type", Target = "~T:Delta.CertXplorer.UI.FolderTreeNode")]
