...
{
    internal sealed class OpenCertificateCommand : BaseOpenDocumentCommand<X509Object>
    {
        public OpenCertificateCommand() : base() { }

        public override string Name => "Open Certificate Document";

        protected override IDocument OpenDocument(object[] arguments)
        {
            X509Object x509 = null;
            if (arguments != null && arguments.Length > 0 && arguments[0] is X509Object x509object)
                x509 = x509object;
            ...
            if (x509 == null)
            {
                ...
                {
                    var storeName = dialog.SelectedValue.StoreName;
                    var storeLocation = dialog.SelectedValue.StoreLocation;
